...
namespace Vaquinha.AutomatedUITests
{
	public class DriverFactory
    {
        ...
        public DriverFactory()
        {
            ...
            ChromeDriverService service = ChromeDriverService.CreateDefaultService("D:/dotnet-drivers/");
            // FirefoxDriverService service = FirefoxDriverService.CreateDefaultService("D:/dotnet-drivers/");
